  ...
  return (
    <AuthProvider>
      ...
      >
        ...
        <Stack.Screen name="forgot-password" options={{ ...headerWithBack, title: 'Forgot Password' }} />
        <Stack.Screen
          name="(tabs)"
          options={{
            headerShown: false,
        ...
        />
        <Stack.Screen name="friend/[friendId]" options={{ ...headerWithBack, title: 'Friend' }} />
        <Stack.Screen name="group/[groupId]" options={{ ...headerWithBack, title: 'Group' }} />
